...
public class PromptController {
	...
	public ResponseEntity<PromptDetailResponse> readPromptDetail(@PathVariable String promptUuid,
		HttpServletRequest request,
		HttpServletResponse response) {
		promptService.updateHit(promptUuid, request, response);
		PromptDetailResponse prompt = promptService.findByPromptUuid(promptUuid);
		return ResponseEntity.ok(prompt);
	}

	@ApiOperation(value = "프롬프트 삭제", notes = "프롬프트를 삭제한다.")
	@DeleteMapping("/{promptUuid}")
	public ResponseEntity<?> deletePrompt(@PathVariable String promptUuid) {
		promptService.deletePrompt(promptUuid);
	...
	public ResponseEntity<ForkPromptResponse> createForkPrompt(@PathVariable String promptUuid,
		...
		ForkPromptResponse forkPrompt = promptService.createForkPrompt(promptUuid, data, thumbnail);
	...
	public ResponseEntity<ForkedPromptListResponse> readForkedPrompt(@PathVariable String promptUuid) {
